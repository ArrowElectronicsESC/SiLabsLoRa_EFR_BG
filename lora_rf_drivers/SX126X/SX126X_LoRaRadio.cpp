...
SX126X_LoRaRadio::SX126X_LoRaRadio(unsigned int mosi,
    ...
    : _spi(mosi, miso, sclk),
      _chip_select(gpioPortA,nss,gpioModeInput, 1),
      _reset_ctl(gpioPortC,reset,gpioModeInput, 1),
      _dio1_ctl(gpioPortD,dio1,gpioModeInput, 0),
      _busy(gpioPortD,busy,gpioModeInput, 0 ),
      _freq_select(gpioPortB,freq_select,gpioModeInput, 0),
      _dev_select(gpioPortB,device_select,gpioModeInput, 0),
      _crystal_select(gpioPortC,crystal_select, gpioModeInput, 0),
      _ant_switch(gpioPortD,ant_switch, gpioModeInput, 1)
{
    _radio_events = NULL;
    _reset_ctl = 1;
